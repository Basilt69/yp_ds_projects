...
|05|Introduction to machine learning|Tha main aim of the project is to create a model to predict tariff for a mobile operator client|scikit-learn, matplotlib, numpy, pandas|
|06|Supervised learning|The task of this project is on the basis of historical data to predict whether a client termines the contract with the bank and leaves it|scikit-learn, matplotlib|
