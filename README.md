...
|06|Supervised learning|The task of this project is on the basis of historical data to predict whether a client terminates the contract with the bank and leaves it|scikit-learn, matplotlib|
